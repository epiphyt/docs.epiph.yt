...
Lade zuerst Block Control von WordPress.org herunter:

<a class="epiphyt-button is-primary" href="https://de.wordpress.org/plugins/block-control/">Block Control herunterladen</a>
...
Nach dem Upload sollten sie unter `wp-content/plugins/block-control` abgelegt sein.
