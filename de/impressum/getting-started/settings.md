...
Die Impressum-Einstellungen bestehen aus Daten, die du in deinem Impressum anzeigen solltest. Je nach gewählter Rechtsform und Land unterscheidet sich die Anzahl der Felder. Impressum Plus und Impressum versuchen, dir Informationen darüber zu geben, welche Felder für deine Rechtsform erforderlich sind. Einerseits über eine Beschreibung unter dem Feld, andererseits über eine Warnmeldung auf jeder anderen Admin-Seite. Die dort angezeigten Felder sind die mindestens erforderlichen Felder.

Aktuell werden die folgenden Rechtsformen von Impressum Plus unterstützt:
...
Aktuell werden die folgenden Rechtsformen von Impressum unterstützt:
...
Bitte verwende diese Information zur Barrierefreiheit nur, wenn sie rechtlich erforderlich ist. Andernfalls kannst du dich rechtlich angreifbar machen.

### Beschreibung

Du benötigst eine Beschreibung deines Dienstes. Beschreibe daher genau, worum es auf deiner Website geht und was ihr Zweck ist.

### Inkompatibilitäten/Ausnahmen
...
Wenn du die Einstellung **Dieses WordPress sendet Daten** aktivierst, kannst du einen oder mehrere Empfänger hinzufügen, um Impressum-Daten und Feldtitel dorthin zu senden. Die Authentifizierung funktioniert entweder über Benutzername/Passwort oder einen Token.
...
Nach dem Aktivieren deiner Lizenz kannst du auch deine Lizenz für die aktuelle Website hier deaktivieren.
