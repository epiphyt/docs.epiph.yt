...
First, download Multisite Auto Language Switcher from WordPress.org:

<a class="epiphyt-button is-primary" href="https://wordpress.org/plugins/multisite-auto-language-switcher/">Download Multisite Auto Language Switcher</a>
...
After the upload, they should be found in `wp-content/plugins/multisite-auto-language-switcher`.
