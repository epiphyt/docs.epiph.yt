...
The imprint settings consist of data you should display in your imprint. Depending on your selected legal entity and country, the amount of fields differ. Impressum Plus and Impressum try to provide you with information about which fields are required for your legal entity. On the one hand via a description below the field, on the other hand via a warning message on every other admin page. The fields displayed there are the minimum required fields.

Currently supported legal entities by Impressum Plus:
...
Currently supported legal entities by Impressum:
...
Please use this accessibility information only if required law. Otherwise, you could make yourself legally vulnerable.

### Description

You need to set a description of your service. For your website, make clear what your website is about and what’s its purpose.

### Incompatibilities/Exceptions
...
If you enable the setting **This WordPress is sender**, you can add one or multiple recipients to send imprint data and field titles to. Authentication can be done via username/password or a token.
...
After activating your license, you can also deactivate your license for your current website here.
